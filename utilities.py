...
# Batch represents a complemeted episode or completion of max steps
class Batch():
	def add_data(self, state, action, reward, value):
...
# Below preprocessing code borrowed from dgriff777
# https://github.com/dgriff777/rl_a3c_pytorch/blob/master/environment.py
